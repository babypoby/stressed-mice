...
OUTPUT_DIR="$SCRATCH/data_oxidation/promoters_intersect"
ANNOTATION_FILE="/nfs/nas12.ethz.ch/fs1201/green_groups_let_public/Euler/Vakil/mouse_genome_annotation/Genes_Promoters_CpG_islands_for_Tae/knownGenes_canonTr_2000bp_upstream_TSS_feature_GRCm39_GENCODE.VM36.bed"
